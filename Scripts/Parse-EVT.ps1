...
#Name: Server 2003 Failed Logon
#Log Type: EVTLOG
#Generated: 8/30/2013 11:27:06 PM
...
$Destination = "SERVER01 2003 Failed Logon Archived Logs.CSV"
...
$SQLQuery = "SELECT timegenerated, EXTRACT_TOKEN(Strings,1,'|') AS Domain, RESOLVE_SID(EXTRACT_TOKEN(Strings,0,'|')) AS User, EXTRACT_TOKEN(Strings,5,'|') AS CSHIP, EXTRACT_TOKEN(Strings,11,'|') AS IP, EventID  INTO '" + $Destination + "' FROM  'X:\Logs\*.evt' WHERE EventID=529 ORDER BY timegenerated "

...
Write-Host "`n
Random Password 6: " -foregroundcolor green -nonewline; write-host $(generate-pass); write-host
'________________________________________'



Write-Host "`n
Random Password 7: " -foregroundcolor green -nonewline; write-host $(generate-pass); write-host
'________________________________________'



Write-Host "`n
Random Password 8: " -foregroundcolor green -nonewline; write-host $(generate-pass); write-host
'________________________________________'



Write-Host "`n
Random Password 9: " -foregroundcolor green -nonewline; write-host $(generate-pass); write-host
'________________________________________'



Write-Host "`n
Random Password 10: " -foregroundcolor green -nonewline; write-host $(generate-pass); write-host
'________________________________________'
